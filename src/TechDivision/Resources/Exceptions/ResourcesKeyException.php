...
/**
 * This is the exception that is thrown if resources with
 * the requested key are not found and the isReturnNull()
 ...
 * @license GPL
 */
class TechDivision_Resources_Exceptions_ResourcesKeyException
    extends Exception {
}