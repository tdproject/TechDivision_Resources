...
/**
 * This is the exception that is thrown if an
 * the requested system locale does not exist.
 *
 * @package TechDivision_Resources
 ...
 * @license GPL
 */
class TechDivision_Resources_Exceptions_SystemLocaleNotExistsException
    extends Exception {
}