...
require_once 'TechDivision/Resources/DBResources.php';
 ...
 * @license GPL
 */
class TechDivision_Resources_DBResourcesFactory
	...
	protected function createResources(
		...
		$resources = new TechDivision_Resources_DBResources($name, $config);
